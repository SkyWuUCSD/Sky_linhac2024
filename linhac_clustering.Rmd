...
df%>%group_by(clusters)%>%summarize(clus_mean_time=mean(mean_time),
                                    clus_mean_pass=mean(mean_pass),
                                    clus_mean_ozone_time=mean(mean_ozone_time),
                                    clus_mean_cm_xg=mean(mean_cmltv_xG),
                                    clus_mean_goal=mean(mean_goals),
                                    clus_mean_shots=mean(mean_shots))
